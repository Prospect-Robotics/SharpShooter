  ...
  private void configureBindings() {
    MANUAL_INTAKE.onTrue(
        new ParallelCommandGroup(
            new InstantCommand(amp::pushIn, amp), new InstantCommand(intake::intake, intake)));
    MANUAL_INTAKE.onFalse(
        new ParallelCommandGroup(
            new InstantCommand(amp::stop, amp), new InstantCommand(intake::stop, intake)));

    MANUAL_OUTTAKE.onTrue(
        new ParallelCommandGroup(
            new InstantCommand(amp::pushOut, amp), new InstantCommand(intake::outtake, intake)));
    ...
    AMP.onFalse(
        new ParallelCommandGroup(
            new InstantCommand(elevator::disable, elevator), new InstantCommand(amp::stop, amp)));
